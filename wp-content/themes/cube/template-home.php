	...
	<div id="inner-content">
		...
		<div class="featured-section white-top">
			...
			<div class="feat-pop-posts container">
				<div class="row">
					<div class="span2">
						<a href="#" class="pop-button active"><span><i class="icon-globe"></i><?php _e("Popular","um_lang"); ?></span></a>
						<a href="#" class="feat-button"><span><i class="icon-trophy"></i><?php _e("Featured","um_lang"); ?></span></a>
					</div>

                    <?php get_template_part("loop","popular-slider"); ?>

                    <?php get_template_part("loop","featured-slider"); ?>
