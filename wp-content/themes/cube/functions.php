...
if($UM_CROP_IMAGES){
    ...
    add_image_size("related_image", 370, 278, true);
    add_image_size("um_thumbnail", 162, 105, true);
    add_image_size("um_thumbnail_2", 236, 177, true);
    add_image_size("um_thumbnail_3", 370, 278, true);
    add_image_size("um_thumbnail_3_variable", 370, 278, false);
    add_image_size("featured_slider", 570, 308, true);
    add_image_size("slider_image", 285, 214, true);
...
/*Includes*/
require_once "includes/aq_resize.php";
...
function signup_user(){
    ...
    if(username_exists( $user_name )){
		...
		$headers = 'From: '.site_url().' <'.get_option("admin_email").'>' . "\r\n";
        wp_mail($user_email,site_url().__(" Thank you for your registration","um_lang"),$message,$headers);
...
function um_reset_password(){
	...
	$_POST['user_login'] = $_POST["um_email"];
...
function add_external_stylesheets(){
    ...
    wp_enqueue_style("jqueryui", "https://code.jquery.com/ui/1.9.1/themes/base/jquery-ui.css", false, "1.0");
    ...
    if($font && $font != "--None--"){
        ...
        wp_enqueue_style("googlefont1", "https://fonts.googleapis.com/css?family=Dosis:200,300,400,500,600,700,800", false, "1.0");
    }
    /*Grey Skin Font*/
    wp_enqueue_style("googlefont2", "https://fonts.googleapis.com/css?family=Montserrat:400,700", false, "1.0");
    if(get_field("theme_skin","options") == "white"){
        /*White Skin Font*/
        wp_enqueue_style("arvo", "https://fonts.googleapis.com/css?family=Arvo:400,700,400italic,700italic", false, "1.0");
    }
