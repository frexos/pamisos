	...
	<div id="inner-content">
		...
		<div class="main-section">
			<div class="home-one container">
				<div class="row">
                    <div class="span8">
                        <a href="http://www.pamisos-messini.gr/%CF%83%CE%BA%CE%BF%CF%80%CF%8C%CF%82/">
...
//                                    $arguments["posts_per_page"] = 4;
                    ...
                    <div class="span4">
                        ...
                        <div class="home-articles">
                            <?php
                            $loop = new WP_Query( array( 'post_type' => 'news', 'ignore_sticky_posts' => 1, 'posts_per_page' => 4, 'orderby' => 'date' ) );
                            if ( $loop->have_posts() ) :
