<?php
    $user_slug = urldecode(get_query_var("user_slug"));
    if($user_slug){
		...
		<div class="row">
			<div class="span8 user-posts">
                <div class="profile-btn__container">
                    <div>
                        <a style="float: left; margin-right: 20px" href="<?php echo site_url()."/".$GLOBALS["um_submit"]; ?>" class="pam-hero-btn new-post-button highlighted-button"><?php _e("Ανεβάστε Νέα Φωτογραφία","um_lang"); ?></a>
                    </div>
                    <div>
                        <a href="<?php echo site_url(); ?>" class="pam-hero-btn new-post-button highlighted-button"><?php _e("Πίσω στην Αρχική","um_lang"); ?></a>
                    </div>
                </div>
